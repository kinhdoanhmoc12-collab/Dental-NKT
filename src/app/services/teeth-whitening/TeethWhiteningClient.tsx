...
export default function TeethWhiteningClient() {
  ...
  return (
    <div className="pt-6 pb-12 space-y-20 w-full max-w-5xl mx-auto px-4 sm:px-6 overflow-x-hidden">
          ...
          <div className="relative z-10 space-y-6 max-w-3xl">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-slate-700/80 w-full">
              <div>
                ...
                <span className="text-xl sm:text-2xl font-extrabold text-teal-brand whitespace-nowrap">
              ...
              <Link 
                href="/contact" 
                className="inline-flex items-center justify-center bg-teal-brand hover:bg-teal-700 text-white font-bold px-7 py-3.5 rounded-full text-xs sm:text-sm transition-all shadow-lg hover:scale-105 whitespace-nowrap w-full sm:w-auto text-center block"
              >
      ...
      <section className="bg-gradient-to-br from-[#0b1e2c] via-[#0f2a3f] to-[#0b1e2c] text-white rounded-3xl p-5 sm:p-8 md:p-12 text-center space-y-6 relative overflow-hidden">
