...
export default function Header() {
  ...
  const currentFlag = lang === "AU" ? "https://flagcdn.com/au.svg" : "https://flagcdn.com/vn.svg";
  ...
  const navLinks = [
    ...
    { name: lang === "VN" ? "Chính sách bảo hành" : "Warranty Policy", href: "/warranty-policy" }
  ];
  ...
  return (
    <header className="sticky top-0 z-50 w-full shadow-md">
      ...
      <div className="hidden md:block bg-[#0b1e2c] text-slate-300 px-4 sm:px-6 lg:px-8 border-b border-slate-800 text-xs py-2.5">
        <div className="max-w-[90rem] mx-auto flex flex-col md:flex-row justify-between items-center gap-2 md:gap-0">
      ...
      <div className="bg-white/95 backdrop-blur-md border-b border-slate-100 shadow-md">
        <div className="max-w-[90rem] mx-auto flex items-center justify-between pr-4 sm:pr-6 lg:pr-8 h-16 md:h-20">
            ...
            >
              <div className="bg-teal-brand text-white px-5 pr-10 md:px-6 md:pr-12 xl:px-4 xl:pr-10 2xl:px-6 2xl:pr-12 flex items-center relative [clip-path:polygon(0_0,100%_0,85%_100%,0_100%)] select-none h-16 md:h-20 whitespace-nowrap">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-serif text-xl sm:text-2xl md:text-2.5xl xl:text-lg 2xl:text-2xl font-extrabold tracking-tight">Dental NKT</span>
                </div>
              </div>
            </Link>
          </div>
          ...
          <nav className="hidden xl:flex items-center gap-2 2xl:gap-4">
            {navLinks.map((link) => {
              if (link.href === "/services") {
                ...
                return (
                  ...
                  >
                    <button
                      className={`font-bold text-[0.82rem] 2xl:text-[0.92rem] transition-colors flex items-center gap-1 cursor-pointer bg-transparent border-none outline-none whitespace-nowrap nav-link-hover ${
                        isServicesActive
              ...
              return (
                <Link
                  ...
                  className={`font-bold text-[0.82rem] 2xl:text-[0.92rem] transition-colors py-2 whitespace-nowrap nav-link-hover ${
                    isActive 
                      ? "text-teal-brand nav-link-active font-black" 
                      : "text-[#0b1e2c] hover:text-teal-brand"
                  }`}
            ...
            <div className="relative group py-2">
              ...
              <div className="absolute top-full right-0 bg-white shadow-xl border border-slate-100 rounded-2xl py-2 w-48 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto translate-y-2 group-hover:translate-y-0 transition-all duration-200 z-50 before:content-[''] before:absolute before:-top-6 before:left-0 before:right-0 before:h-6">
                ...
                >
                  <img src="https://flagcdn.com/au.svg" alt="Australia" className="w-6 h-4 object-cover rounded-sm" /> Australia (AUD)
                </button>
                <button 
                  onClick={() => selectLanguage("VN")} 
                  className="w-[calc(100%-16px)] mx-2 text-left px-4 py-2.5 text-xs font-bold text-slate-700 hover:bg-teal-brand/5 hover:text-teal-brand hover:pl-5 transition-all duration-200 rounded-lg flex items-center gap-2 cursor-pointer border-none outline-none"
                >
                  <img src="https://flagcdn.com/vn.svg" alt="Vietnam" className="w-6 h-4 object-cover rounded-sm" /> Việt Nam (VND)
                </button>
              </div>
            </div>
          </nav>
          ...
          <div className="flex items-center gap-4">
            ...
            <button 
              ...
              className="xl:hidden p-2.5 text-[#0b1e2c] hover:text-teal-brand focus:outline-none"
          ...
          <div className="xl:hidden bg-white border-t border-slate-100 px-6 py-6 space-y-4 animate-fade-in absolute w-full left-0 top-full shadow-xl z-50">
            ...
            <div className="py-2 border-b border-slate-50">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <img src="https://flagcdn.com/au.svg" alt="Australia" className="w-6 h-4 object-cover rounded-sm" />
                  AU (AUD)
                </button>
                <button 
                ...
                >
                  <img src="https://flagcdn.com/vn.svg" alt="Vietnam" className="w-6 h-4 object-cover rounded-sm" />
                  VN (VND)
                </button>
              </div>
            </div>
