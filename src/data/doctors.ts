...
export const DOCTORS_DATA: Record<string, DoctorDetail> = {
  ...
  d2: {
    ...
    associationsVN: [
      ...
      "Tham dư chương trình hội thảo của Operation Smile tại Mỹ về các vấn đề môi vòm đặc biệt chỉnh nha cho bệnh nhân bị khe hở môi vòm (5/2014)",
